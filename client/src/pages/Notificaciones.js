  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-800 mb-1">🔔 Notificaciones</h1>
          <p className="text-gray-600">Todas tus notificaciones del sistema</p>
        </div>
              ...
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-2xl">{getTipoIcono(notificacion.tipo)}</span>
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <h3 className="text-lg font-bold text-gray-800">{notificacion.titulo}</h3>
                        {!notificacion.leida && (
                          <span className="px-2 py-1 bg-green-500 text-white rounded-full text-xs font-semibold">
                            Nuevo
                          </span>
                        )}
                        <span className={`px-2 py-1 rounded-full text-xs font-semibold ${getTipoColor(notificacion.tipo)}`}>
                          {notificacion.tipo}
                        </span>
                      </div>
